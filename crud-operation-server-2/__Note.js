/**
 * 1. open package.js and add '    "start": "node index.js",' in scripts object.
 * 2. create a js file. File accroding package.json file main object value.
 * 3. install dotenv. Install command: npm install dotenv
 * 4. create file in root path. File name must be .env
